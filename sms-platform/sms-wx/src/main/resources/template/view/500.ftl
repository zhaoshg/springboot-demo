...
<div class="hj_wrapPage">
    ...
    <div class="bd">
        <div class="wbd">
            <div class="bd_wrapImgList div_center">
                 500 ERROR ！
            </div>
        </div>
        <div class="bd_wrapImgList1 div_center">
        </div>

        <div class="ft">
            <div class="bd_wrapImgList00">
                <center><p><#if exception??>${exception.getMessage()}</#if></p></center>
            </div>
        </div>
    </div>
</div>
